...
static STK_T _kernel_sstack_BT_ECHO_TASK[COUNT_STK_T(DEFAULT_SSTKSZ)] __attribute__((section(".prsv_kernel"),nocommon));
...
static STK_T _kernel_ustack_BT_ECHO_TASK[COUNT_STK_T(4096)] __attribute__((section(".ustack_BT_ECHO_TASK"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	...
	{ &_kernel_dominib_table[INDEX_DOM(TDOM_APP)], (TA_ACT), (intptr_t)(0), ((TASK)(main_task)), INT_PRIORITY(TMIN_APP_TPRI), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_MAIN_TASK, ROUND_STK_T(4096), _kernel_ustack_MAIN_TASK, (TA_NULL), (NULL), { TACP(TDOM_APP), TACP(TDOM_APP), TACP(TDOM_APP), TACP(TDOM_APP) }},
	{ &_kernel_dominib_table[INDEX_DOM(TDOM_APP)], (TA_NULL), (intptr_t)(0), ((TASK)(bluetooth_echo_task)), INT_PRIORITY(TMIN_APP_TPRI + 1), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_BT_ECHO_TASK, ROUND_STK_T(4096), _kernel_ustack_BT_ECHO_TASK, (TA_NULL), (NULL), { TACP(TDOM_APP), TACP(TDOM_APP), TACP(TDOM_APP), TACP(TDOM_APP) }}
};
...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, USBMSC_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, EV3RT_LOGTASK, APP_INIT_TASK, MAIN_TASK, BT_ECHO_TASK
};
...
STK_T _kernel_ustack_TOPPERS_DUMMY3[COUNT_STK_T(4096)] __attribute__((section(".ustack_TOPPERS_DUMMY3"),nocommon));
