...
ID _module_id_BT_ECHO_TASK __attribute__((section (".module.text")));
static STK_T _module_ustack_BT_ECHO_TASK[COUNT_STK_T(STACK_SIZE)];
...
static const T_CTSK _module_ctsk_tab[3] = {
	...
	{ TA_ACT, 0, main_task, TMIN_APP_TPRI, ROUND_STK_T(STACK_SIZE), _module_ustack_MAIN_TASK, DEFAULT_SSTKSZ, NULL },
	{ TA_NULL, 0, bluetooth_echo_task, TMIN_APP_TPRI + 1, ROUND_STK_T(STACK_SIZE), _module_ustack_BT_ECHO_TASK, DEFAULT_SSTKSZ, NULL },
};
...
const MOD_CFG_ENTRY _module_cfg_tab[3] = {
	...
	{ TSFN_CRE_TSK, &_module_ctsk_tab[2], &_module_id_BT_ECHO_TASK },
};
